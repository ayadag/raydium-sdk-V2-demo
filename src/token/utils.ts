...
export const RPC_URL = process.env.RPC? process.env.RPC : `https://api.devnet.solana.com/`;
...
export const payer: Keypair = Keypair.fromSecretKey(Uint8Array.from(bs58.decode(PAYER)))
...
export const mint = new PublicKey('2ApUVwDc1R4rGd2GT5iiB7z1PdJtUuZgtEnC41WuP3Eb');//2ApUVwDc1R4rGd2GT5iiB7z1PdJtUuZgtEnC41WuP3Eb
